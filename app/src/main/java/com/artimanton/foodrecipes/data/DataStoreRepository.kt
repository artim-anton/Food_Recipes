...
import com.artimanton.foodrecipes.util.Constrans.Companion.PREFERENCES_MEAL_TYPE_ID
import com.artimanton.foodrecipes.util.Constrans.Companion.PREFERENCES_NAME
    ...
    val readMealAndDietType: Flow<MealAndDietType> = context.dataStore.data
        ...
        .map { preferences ->
            val selectedMealType =
                preferences[PreferenceKeys.selectedMealType] ?: Constrans.DEFAULT_MEAL_TYPE
            val selectedMealTypeId = preferences[PreferenceKeys.selectedMealTypeId] ?: 0
            val selectedDietType =
                preferences[PreferenceKeys.selectedDietType] ?: Constrans.DEFAULT_DIET_TYPE
